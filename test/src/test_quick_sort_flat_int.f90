...
!> 
!> @details
!> Test the quick_sort_flat interface for integer values.
!> 
!> @author Arin R. Bratt
!> @date 15/07/2014
program test_quick_sort_flat_int
  use bsort
  use orders
  ...
  ! Headers
  print *
  print *,"Test a flat three way quick sort with integer values."
  ...
  print *
end program test_quick_sort_flat_int
