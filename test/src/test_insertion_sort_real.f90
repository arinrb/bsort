!> @ingroup test
!> @brief
!> Test the insertion_sort interface.
!> 
!> @details
!> Test the insertion_sort interface for real values.
!> 
!> @author Arin R. Bratt
!> @date 15/07/2014
program test_insertion_sort_real
  use bsort
  use orders
  ...
  ! Headers
  print *
  print *,"Test an insertion sort with real values."
  ...
  print *
end program test_insertion_sort_real
