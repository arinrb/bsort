...
!> 
!> @details
!> Test the insertion_sort interface for integer values.
!> 
!> @author Arin R. Bratt
!> @date 15/07/2014
program test_insertion_sort_int
  use bsort
  use orders
  ...
  ! Headers
  print *
  print *,"Test an insertion sort with integer values."
  ...
  print *
end program test_insertion_sort_int
