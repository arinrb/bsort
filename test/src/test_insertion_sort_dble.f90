...
!> 
!> @details
!> Test the insertion_sort interface for double precision values.
!> 
!> @author Arin R. Bratt
!> @date 15/07/2014
program test_insertion_sort_dble
  use bsort
  use orders
  ...
  ! Headers
  print *
  print *,"Test an insertion sort with double precision values."
  ...
  print *
end program test_insertion_sort_dble
