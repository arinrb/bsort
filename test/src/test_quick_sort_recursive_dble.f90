...
!> 
!> @details
!> Test the quick_sort_recursive interface for double precision values.
!> 
!> @author Arin R. Bratt
!> @date 15/07/2014
program test_quick_sort_recursive_dble
  use bsort
  use orders
  ...
  ! Headers
  print *
  print *,"Test a recursive three way quick sort with double precision values."
  ...
  print *
end program test_quick_sort_recursive_dble
