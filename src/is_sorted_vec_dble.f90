...
pure function is_sorted_vec_dble(vec,ascending) result(is_sorted)
  ...
  if (ascending) then
     is_sorted = is_sorted_vec_asc_dble(vec)
  else
     is_sorted = is_sorted_vec_dec_dble(vec)
  end if

end function is_sorted_vec_dble
