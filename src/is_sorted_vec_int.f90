...
pure function is_sorted_vec_int(vec,ascending) result(is_sorted)
  ...
  if (ascending) then
     is_sorted = is_sorted_vec_asc_int(vec)
  else
     is_sorted = is_sorted_vec_dec_int(vec)
  end if

end function is_sorted_vec_int
