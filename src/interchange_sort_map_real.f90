...
pure subroutine interchange_sort_map_real(vec,map,ascending)
  ! Arguments
  ...
  ! Main
  if (ascending) then
     call interchange_sort_asc_map_real(vec,map)
  else
     call interchange_sort_dec_map_real(vec,map)
  end if
end subroutine interchange_sort_map_real
