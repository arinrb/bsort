...
!>
!> @brief
!> Check if a vector of integer values is sorted by an ascending order. 
!> 
!> @details
...
!> @author Arin R. Bratt
!> @date 05/07/2014
pure function is_sorted_vec_asc_int(vec) result(is_sorted)
  ! Result
  logical :: is_sorted
  ...
  is_sorted = .true.
end function is_sorted_vec_asc_int
