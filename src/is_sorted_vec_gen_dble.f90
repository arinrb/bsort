...
!>
!> @brief
!> Check if a vector of double precision values is sorted by the specified order. 
!> 
!> @details
...
!> @author Arin R. Bratt
!> @date 05/07/2014
function is_sorted_vec_gen_dble(vec,ord) result(is_sorted)
  ! Result
  logical :: is_sorted
  ...
  is_sorted = .true.
end function is_sorted_vec_gen_dble
