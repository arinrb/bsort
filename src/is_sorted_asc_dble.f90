...
!>
!> @brief
!> Check if a vector of double precision values is sorted by an ascending order. 
!> 
!> @details
...
!> @author Arin R. Bratt
!> @date 10/07/2014
pure function is_sorted_asc_dble(x) result(sorted)
  ...
  sorted = .true.
end function is_sorted_asc_dble
