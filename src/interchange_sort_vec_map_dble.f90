...
!> @author Arin R. Bratt
!> @date 07/07/2014
pure subroutine interchange_sort_vec_map_dble(vec,map,ascending)
  ! Arguments
  ...
  if (ascending) then
     ...
     call interchange_sort_vec_dec_map_dble(vec,map)
  end if
end subroutine interchange_sort_vec_map_dble
